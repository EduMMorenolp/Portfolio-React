...
function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Proyecto Final, donde se implemento Springboot y Thymeleaf para su realizacion, en colovaricon con un equipo de 10 personas, tomando roles y diviendose las tareas',
